...
async function getListing(slug: string) {
    // 1. Fetch listing from RTDB
	let listing = await listingService.getListing(slug);
...
export default async function ListingPage({
	...
	try {
		await listingService.updateListing(listing._id, { views: (listing.views || 0) + 1 });
	} catch (e) {
